  ...
  return (
    <div>
        <header className='h-28 border-b'>
            <div className="logo h-full items-center mx-[5%] sm:mx-[15%] flex justify-between ">
                <img className='h-8 sm:h-16' src="https://i.ibb.co/jVh8NgW/Dipto-Dey.png" alt="" srcSet="" />
                <div className="flex gap-x-10">
                    <button>
                        <svg className="w-6 sm:w-[30] h-6 sm:h-[30]" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className="">
                        <Link to='/'>
                            <svg className="w-5 sm:w-[25] h-5 sm:h-[25]" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <main>
           <div className="flex justify-center items-center">
                <div className="from-body mx-[10%] flex flex-col lg:flex-row items-center gap-x-20 pb-20">
                    <div className="flex flex-col items-center">
                        <img className='w-[70%] sm:w-[50%] md:w-[40%] lg:w-[300px] block' src="https://i.ibb.co/H7xZTHN/a1.png" alt="" srcSet="" />
                        <h2 className='text-base sm:text-[18px] md:text-[20px] lg:text-[22px] font-medium text-center mt-20 w-full lg:w-[400px]'>I’m excited to learn about your project. Ready to get started?</h2>
                    </div>

                    <div className="flex justify-center">
                        <form className='w-full lg:w-[500px] mx-auto mt-16 px-5 sm:px-10 py-10 rounded-[10px] shadow-2xl flex flex-col gap-y-6' action="">
